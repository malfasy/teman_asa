...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _handleSignUp() async {
    ...
    // Panggil Service Simulasi
    bool success = await _authService.signUpWithEmailAndPassword(email, password);
    
    if (success && mounted) {
      // Set status belum inisiasi karena user baru
          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text("GOOGLE (SIMULASI)"),
              ),
            ),
          ],
        ),
